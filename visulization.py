...
def apply(train_data: pd.DataFrame, test_data: pd.DataFrame, max_features: int) -> tuple:
   
    try# split data into X and y
...
def main():
    try:
        ...
        train_df, test_df = apply(train_data, test_data, max_features)
